...
// Helper function to create slug from hospital name
...
export default function SharePage() {
      ...
      try {
        ...
        if (response.data && response.data.data && response.data.data.stats) {
          ...
          setStats({
            ...
            views: Math.floor(totalBookings * 2.5) + 12 // Mock formula for views based on real bookings
          });
        }
      } catch (error) {
  ...
  // Create slug from hospital name
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text: `Book your appointment with ${doctorName}`,
          url: bookingLink,
        });
      } catch (err) {
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <Button
                  ...
                  onClick={() => window.open(`https://wa.me/?text=Book your appointment with ${encodeURIComponent(doctorName)}: ${bookingLink}`)}
                >
            ...
            <div className="rounded-lg bg-secondary/50 p-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-success">{stats.bookings}</p>
